...
- 📁 Archivos nuevos: functions/index.js, functions/package.json, functions/README.md, functions/.gitignore, firestore.rules, firestore.indexes.json, firebase.json, .firebaserc
