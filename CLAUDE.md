...
terminos.html                   ← Términos y Condiciones (plantilla genérica, ver nota técnica 13)
privacidad.html                 ← Política de Privacidad (plantilla genérica, ver nota técnica 13)
...
- [ ] **Pagos** — Integración de Stripe o PayPal pendiente de implementar (el flujo de pago sigue siendo simulado). **Guía completa entregada al usuario en sesión 7** (ver nota técnica 9) — pendiente decidir cuándo implementarla
